...
#
par(mar=c(5,5,5,7))
image(x=seps12,y=seps23,z=log10(mat_data_eresol), axes=FALSE,
      zlim=c(log10(minzFWHM),log10(maxzFWHM)),col=tim.colors(400),
      xlab="Time2 from previous pulse [samples]", ylab="Time to next pulse [samples]",
...
par(mar=c(5,5,5,3.5))
image.plot(x=seps12,y=seps23,z=log10(mat_data_eresol),
      axis.args=list( at=log10(ticks),  labels=ticksLabels),
      zlim=c(log10(minzFWHM),log10(maxzFWHM)),col=tim.colors(400),
      xlab="Time0 from previous pulse [samples]",
